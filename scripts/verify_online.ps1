...
if ($_fast300Daily) {
    ...
    if (Test-Path $_sdmMetaPath) {
        try {
            ...
            # iter95: NO deferral — density_deferred_by_aws_devdoc_swap removed
            if (-not $_sdmGatePass) {
...
if ($_fast300Daily) {
    ...
    if (Test-Path $_piPath) {
        try {
            ...
            # iter95: NO deferral — per_item_sd_deferred removed
...
if ($_fast300Daily) {
    ...
    if (Test-Path $_sdgMetaPath) {
        try {
            ...
            # iter95: NO deferral — strategic_density_deferred removed
